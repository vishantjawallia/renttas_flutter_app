                  ...
                  InkWell(
                    onTap: () =>
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (
                                    context) => const inentorydashboard())),
                    child: Icon(
                      Icons.arrow_back,
                      size: 30,
                    ),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) =>  newproductadd(type:"0",id:"",productname: "",descr: "",sku: "",)));
        },
      ),
    );
  }
                    ...
                    InkWell(
                      onTap: () =>
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) =>  newproductadd(type:"1",id:id,productname:name,descr:descrip,sku:sku))),
                      child: Container(
                        decoration: BoxDecoration(
