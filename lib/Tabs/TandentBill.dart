...
class TandentBill extends StatefulWidget {
  const TandentBill({Key? key}) : super(key: key);

  @override
  State<TandentBill> createState() => _TandentBillState();
}

class _TandentBillState extends State<TandentBill> {
  String userId = '';
  String name = '';
  String mobile = '';
  ...
  Future<void> loadBill(String mobile) async {
    ...
    final response = await http.post(
      Uri.parse(ApiUrl.getBillByMobile), // Replace with your API endpoint
