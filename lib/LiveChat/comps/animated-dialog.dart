...
// import 'package:renttas_flutter_app/LiveChat/comps/widgets.dart';
...
//                                       ? []
//                                       : snapshot.data!.docs.where((element) => element['email'].toString().contains(search) || element['email'].toString().contains(search)).toList();
