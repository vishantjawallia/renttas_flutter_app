abstract class ApiUrl {
  ...
  //static const baseUrl="https://rental.nucigent.co.in/Api/index.php/api/";
  //LandLord Apis Url
  ...
  static const saveTenant ="${baseUrl}addPropertyTenant"; //addPropertyTenant
  static const getTendentByIds="${baseUrl}gettenantsbyid";  //renttas.com/api./gettenantsbyid
  static const createExpenses="${baseUrl}addexpense";// addexpense addexpense
  ...
  static const deleteDoc="${baseUrl}deleteById/";//deletedocid
  static const deleteExp="${baseUrl}deleteExpense/";
  static const saveBill="${baseUrl}addPropertyBill";//addPropertyBill
  ...
  static const checkmail="${baseUrl}checkmailregisterd"; //renttas.com/api/checkmailregisterd
